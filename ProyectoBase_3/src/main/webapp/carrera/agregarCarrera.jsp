     ...
     <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="/ProyectoBase_3/index.jsp">Escuela Web</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/ProyectoBase_3/index.jsp">Home</a>
                            </li>
                            <li class="nav-item">
...
<a class='btn btn-primary' href='/ProyectoBase_3/carrera/listaDeCarreras.jsp' role='button'>Listado de carreras</a>
</div>
</body>
</html>
